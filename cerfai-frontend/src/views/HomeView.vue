  ...
  <div class="home">
    ...
    <div class="container">
      ...
      <el-form v-show="activeIndex == 'tag'" ref="form" :model="form" label-width="100px">
        <el-form-item label="词条名：">
          <div class="row">
            ...
            <el-button type="primary" v-clipboard:copy="form.name" v-clipboard:success="onCopy" v-clipboard:error="onError">复制词条名</el-button>
          </div>
        </el-form-item>
      ...
      <div class="search" v-show="activeIndex == 'tag_search'">
        ...
        <el-table
          @row-click="getRow"
          :data="search_res" class="searchTable" border fit style="width: 100%">
      ...
      <div class="contributor" v-show="activeIndex == 'contributor'">
        <p>词条贡献榜(每小时更新一次)</p>
        <el-table
          :data="contributor_toplist" class="searchTable" border fit style="width: 100%"
      ...
      <div class="share" v-show="activeIndex == 'share'">
        <p>NovelAI词条贡献站 - 数据开放平台 根据 <a href="https://www.bilibili.com/read/cv19252957" target="_blank">NovelAI信息并联计划公约</a> 约定：</p>
        <p>
        ...
        <p>本站提供接口详见 <a href="https://console-docs.apipost.cn/preview/dbc3a0be7aff05cb/526a9c13fe093c2c?target_id=632986c9-4ce6-4b50-b6b8-409e41be0c4b">接口文档</a></p>
        <p>本站交流群：660612010</p>
