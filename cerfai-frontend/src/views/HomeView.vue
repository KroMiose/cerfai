<template>
    <div class="home">
        <el-menu :default-active="activeIndex" class="menu" mode="horizontal" @select="handleSelect" style="z-index:2"
        ...
        <large-image-title v-show="activeIndex == 'home'" style="position:absolute;top:0px;width: 100%;z-index: 1;"
            :items="imageSet" title="Novelai词条贡献站" height="500">
            <div style="height:25%;"></div>
            <h1>Novelai词条贡献站</h1>
            <small>收到用户贡献词条数: {{ up_cnt }},已收录总词条数: {{ ct_total }}</small><br><br>
            <el-button type="primary" round @click="activeIndex = 'contribute'">前往贡献页面→</el-button>
        </large-image-title>
        <div class="container">
            <!--TODO:文案等待修改-->
            <div class="homePage" v-show="activeIndex == 'home'" style="position:relative;top:450px;">
                <h3>关于本站</h3>
                <div>
            ...
            <div class="search" v-show="activeIndex == 'tag_search'">
                ...
                <search-history :datas="searchHis" @select="k => { this.search_keyword = k, this.search() }"
...
export default {
    ...
    mounted() {
        ...
        categorySelector, largeImageTitle, searchHistory
    }
}
</script>
